...
export const MENU: MenuItem[] = [
  ...
  //     {
  //       id: 8,
  //       label: 'Pending Job Status (Running)',
  //       link: '/analytics',
  //       parentId: 2
  //     },
  //     {
  ...
  //     {
  //       id: 9,
  //       label: 'Payment Pending for Finished Jobs',
  //       link: '/crm',
  //       parentId: 2
  //     },      
  //     {
  //       id: 10,
  //       label: 'Delivered Job Sheets',
  //       link: '/crm',
  //       parentId: 2
  //     },
  //     {
  ...
  //     {
  //       id: 10,
  //       label: 'Mobile Modal Master',
  //       link: '/crm',
  //       parentId: 2
  //     },
  //     {
  //       id: 10,
  //       label: 'Service Status Master',
  //       link: '/crm',
  //       parentId: 2
  //     },
  //     {
